...
#[derive(Debug)]
pub struct ServiceGuardProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ServiceGuardProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ServiceGuard processing");
    
    let mut processor = ServiceGuardProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ServiceGuardProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ServiceGuardProcessor::new(false);
